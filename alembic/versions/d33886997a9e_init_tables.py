...
Revision ID: d33886997a9e
Revises: 
Create Date: 2026-01-05 17:32:12.619928
...
def upgrade() -> None:
    ...
    sa.Enum('NONE', 'LOGIN', 'CONSENT', name='prompt').create(op.get_bind())
    sa.Enum('CODE', name='responsetypes').create(op.get_bind())
    ...
    op.create_table('guard_access_tokens',
    ...
    sa.ForeignKeyConstraint(['client_id'], ['guard_clients.id'], name=op.f('fk_guard_access_tokens_client_id_guard_clients'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['guard_users.id'], name=op.f('fk_guard_access_tokens_user_id_guard_users'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_guard_access_tokens'))
    )
    op.create_index(op.f('ix_guard_access_tokens_created_at'), 'guard_access_tokens', ['created_at'], unique=False)
    op.create_index(op.f('ix_guard_access_tokens_expires_at'), 'guard_access_tokens', ['expires_at'], unique=False)
    op.create_index(op.f('ix_guard_access_tokens_token'), 'guard_access_tokens', ['token'], unique=True)
    op.create_index(op.f('ix_guard_access_tokens_updated_at'), 'guard_access_tokens', ['updated_at'], unique=False)
    op.create_table('guard_authorization_codes',
    sa.Column('code', sa.String(length=255), nullable=False),
    sa.Column('response_type', postgresql.ENUM('CODE', name='responsetypes', create_type=False), nullable=False),
    sa.Column('response_mode', postgresql.ENUM('CODE', name='responsetypes', create_type=False), nullable=False),
    sa.Column('redirect_uri', sa.Text(), nullable=False),
    sa.Column('scope', sa.JSON(), nullable=False),
    sa.Column('state', sa.String(length=2048), nullable=True),
    sa.Column('nonce', sa.String(length=2048), nullable=True),
    ...
    op.create_table('guard_authorization_requests',
    sa.Column('response_type', postgresql.ENUM('CODE', name='responsetypes', create_type=False), nullable=False),
    sa.Column('response_mode', postgresql.ENUM('CODE', name='responsetypes', create_type=False), nullable=False),
    sa.Column('redirect_uri', sa.Text(), nullable=False),
    sa.Column('scope', sa.JSON(), nullable=False),
    sa.Column('prompt', postgresql.ENUM('NONE', 'LOGIN', 'CONSENT', name='prompt', create_type=False), nullable=False),
    sa.Column('state', sa.String(length=2048), nullable=True),
    sa.Column('nonce', sa.String(length=2048), nullable=True),
    sa.Column('code_challenge', sa.String(length=255), nullable=True),
    sa.Column('code_challenge_method', sa.String(length=255), nullable=True),
    ...
    sa.Column('created_at', guard.models.base.UTCDateTime(timezone=True), nullable=False),
    sa.Column('updated_at', guard.models.base.UTCDateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['client_id'], ['guard_clients.id'], name=op.f('fk_guard_authorization_requests_client_id_guard_clients'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['guard_users.id'], name=op.f('fk_guard_authorization_requests_user_id_guard_users'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_guard_authorization_requests'))
    )
    op.create_index(op.f('ix_guard_authorization_requests_created_at'), 'guard_authorization_requests', ['created_at'], unique=False)
    op.create_index(op.f('ix_guard_authorization_requests_updated_at'), 'guard_authorization_requests', ['updated_at'], unique=False)
    ...
    op.create_table('guard_id_tokens',
    sa.Column('token', sa.String(length=255), nullable=False),
    sa.Column('scope', sa.JSON(), nullable=False),
    sa.Column('user_id', guard.models.base.GUID(), nullable=False),
    sa.Column('client_id', guard.models.base.GUID(), nullable=False),
    ...
    sa.Column('updated_at', guard.models.base.UTCDateTime(timezone=True), nullable=False),
    sa.Column('expires_at', guard.models.base.UTCDateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['client_id'], ['guard_clients.id'], name=op.f('fk_guard_id_tokens_client_id_guard_clients'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['guard_users.id'], name=op.f('fk_guard_id_tokens_user_id_guard_users'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_guard_id_tokens'))
    )
    op.create_index(op.f('ix_guard_id_tokens_created_at'), 'guard_id_tokens', ['created_at'], unique=False)
    op.create_index(op.f('ix_guard_id_tokens_expires_at'), 'guard_id_tokens', ['expires_at'], unique=False)
    op.create_index(op.f('ix_guard_id_tokens_token'), 'guard_id_tokens', ['token'], unique=True)
    op.create_index(op.f('ix_guard_id_tokens_updated_at'), 'guard_id_tokens', ['updated_at'], unique=False)
    ...
    sa.ForeignKeyConstraint(['role_id'], ['guard_roles.id'], name=op.f('fk_guard_roles_permissions_role_id_guard_roles'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('role_id', 'permission_id', name=op.f('pk_guard_roles_permissions'))
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_guard_id_tokens_updated_at'), table_name='guard_id_tokens')
    op.drop_index(op.f('ix_guard_id_tokens_token'), table_name='guard_id_tokens')
    op.drop_index(op.f('ix_guard_id_tokens_expires_at'), table_name='guard_id_tokens')
    op.drop_index(op.f('ix_guard_id_tokens_created_at'), table_name='guard_id_tokens')
    op.drop_table('guard_id_tokens')
    ...
    op.drop_index(op.f('ix_guard_authorization_requests_updated_at'), table_name='guard_authorization_requests')
    op.drop_index(op.f('ix_guard_authorization_requests_created_at'), table_name='guard_authorization_requests')
    op.drop_table('guard_authorization_requests')
    ...
    op.drop_index(op.f('ix_guard_access_tokens_updated_at'), table_name='guard_access_tokens')
    op.drop_index(op.f('ix_guard_access_tokens_token'), table_name='guard_access_tokens')
    op.drop_index(op.f('ix_guard_access_tokens_expires_at'), table_name='guard_access_tokens')
    op.drop_index(op.f('ix_guard_access_tokens_created_at'), table_name='guard_access_tokens')
    op.drop_table('guard_access_tokens')
    ...
    sa.Enum('CODE', name='responsetypes').drop(op.get_bind())
    sa.Enum('NONE', 'LOGIN', 'CONSENT', name='prompt').drop(op.get_bind())
    # ### end Alembic commands ###
