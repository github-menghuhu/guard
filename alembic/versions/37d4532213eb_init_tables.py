...
Revision ID: 37d4532213eb
Revises: 
Create Date: 2025-12-17 19:04:41.685003
...
def upgrade() -> None:
    ...
    sa.Enum('ENABLE', 'DISABLE', name='guard_tenant_status').create(op.get_bind())
    ...
    op.create_table('guard_tenants',
    sa.Column('id', guard.models.base.GUID(), nullable=False),
    sa.Column('tenant_name', sa.String(length=255), nullable=False),
    sa.Column('slug', sa.String(length=255), nullable=False),
    sa.Column('status', postgresql.ENUM('ENABLE', 'DISABLE', name='guard_tenant_status', create_type=False), nullable=False),
    sa.Column('contact_person', sa.String(length=50), nullable=True),
    sa.Column('phone', sa.String(length=20), nullable=True),
    sa.Column('created_at', guard.models.base.UTCDateTime(timezone=True), nullable=False),
    sa.Column('updated_at', guard.models.base.UTCDateTime(timezone=True), nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_guard_tenants')),
    sa.UniqueConstraint('slug', name=op.f('guard_tenants_slug_key'))
    )
    op.create_index(op.f('ix_guard_tenants_created_at'), 'guard_tenants', ['created_at'], unique=False)
    op.create_index(op.f('ix_guard_tenants_updated_at'), 'guard_tenants', ['updated_at'], unique=False)
    ...
    sa.Column('created_at', guard.models.base.UTCDateTime(timezone=True), nullable=False),
    sa.Column('updated_at', guard.models.base.UTCDateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['tenant_id'], ['guard_tenants.id'], name=op.f('fk_guard_clients_tenant_id_guard_tenants'), ondelete='CASCADE'),
    ...
    sa.Column('created_at', guard.models.base.UTCDateTime(timezone=True), nullable=False),
    sa.Column('updated_at', guard.models.base.UTCDateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['tenant_id'], ['guard_tenants.id'], name=op.f('fk_guard_users_tenant_id_guard_tenants'), ondelete='CASCADE'),
    ...
    op.create_index(op.f('ix_guard_users_tenant_id'), 'guard_users', ['tenant_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['guard_tenants.id'], name=op.f('fk_guard_oauth_accounts_tenant_id_guard_tenants'), ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['guard_tenants.id'], name=op.f('fk_guard_oauth_sessions_tenant_id_guard_tenants'), ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['guard_tenants.id'], name=op.f('fk_guard_registration_sessions_tenant_id_guard_tenants'), ondelete='CASCADE'),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_guard_users_tenant_id'), table_name='guard_users')
    ...
    op.drop_index(op.f('ix_guard_tenants_updated_at'), table_name='guard_tenants')
    op.drop_index(op.f('ix_guard_tenants_created_at'), table_name='guard_tenants')
    op.drop_table('guard_tenants')
    ...
    sa.Enum('ENABLE', 'DISABLE', name='guard_tenant_status').drop(op.get_bind())
