...
from guard.models import Base, GUID, TimestampMixin, SoftDeleteMixin
...
class Tenant(Base, TimestampMixin, SoftDeleteMixin):
    ...
    status: Mapped[TenantStatus] = mapped_column(Enum(TenantStatus), nullable=False, default=TenantStatus.ENABLE)
