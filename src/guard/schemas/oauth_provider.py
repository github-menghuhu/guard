...
class CreateOAuthProviderParams(BaseModel):
    name: Annotated[str, Field(min_length=1, max_length=50, description="供应商名称")]
...
class UpdateOAuthProviderParams(BaseModel):
    name: Annotated[
        str | None, Field(min_length=1, max_length=50, description="供应商名称")
    ] = None
    client_id: Annotated[str | None, Field(min_length=1, description="客户端ID")] = None
    client_secret: Annotated[
        str | None, Field(min_length=1, description="客户端密钥")
    ] = None
    scopes: Annotated[list[str] | None, Field(min_length=1, description="授权范围")] = (
        None
    )
